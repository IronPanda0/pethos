...
const routes = [
  // 主页
  {
    ...
    meta: {
      title: '主页', //网页标题名称
      inside: true, //是否现在在PetHospital-Admin后台框架内
  ...
  //   path: '/', //主页文件位置
  //   name: 'hometest', //路由名
  //   component: resolve => require(['@/views/login/LoginTest.vue'], resolve), //加载文件位置
  //   meta: {
  //     title: '主页', //网页标题名称
  //     inside: false, //是否现在在PetHospital-Admin后台框架内
  ...
  },
  {
    path: '/disease/add',
    name: 'AddDisease',
    component: resolve => require(['@/views/disease/AddDisease.vue'], resolve),
    meta: {
      title: '病种增加',
      inside: true,
      login: true,
  ...
  },
  {
    path: '/disease/edit',
    name: 'EditDisease',
    component: resolve => require(['@/views/disease/EditDisease.vue'], resolve),
    meta: {
      title: '病种编辑',
      inside: true,
      login: true,
  ...
  //病例模板
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/goods/Model.vue'], resolve),
    meta: {
      title: '病例模板',
      inside: true,
      login: true,
  ...
  // 题库管理
  {
   ...
   // 试卷管理
   {
    path: '/test/paper',
    name: 'error',
    component: resolve => require(['@/views/test/paper.vue'], resolve),
    meta: {
      title: '试卷管理',
      inside: true,
      login: true,
   ...
   // 考试管理
   {
    path: '/test/exam',
    name: 'error',
    component: resolve => require(['@/views/test/exam.vue'], resolve),
    meta: {
      title: '考试管理',
      inside: true,
      login: true,
  ...
  // 职能学习管理
  {
    path: '/RoleStudy',
    name: 'error',
    component: resolve => require(['@/views/RoleStudy/RoleStudy.vue'], resolve),
    meta: {
      title: '职能学习管理',
      inside: true,
      login: true,
  ...
  // 科室管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/OfficeManage.vue'], resolve),
    meta: {
      title: '科室管理',
      inside: true,
      login: true,
  ...
  // 人员管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/HumanManage.vue'], resolve),
    meta: {
      title: '人员管理',
      inside: true,
      login: true,
  ...
  // 药品管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/DrugManage.vue'], resolve),
    meta: {
      title: '药品管理',
      inside: true,
      login: true,
  ...
  // 档案管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/FileManage.vue'], resolve),
    meta: {
      title: '档案管理',
      inside: true,
      login: true,
  ...
  //收费管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/PayManage.vue'], resolve),
    meta: {
      title: '收费管理',
      inside: true,
      login: true,
  ...
  //化验项目管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/LabProjectManage.vue'], resolve),
    meta: {
      title: '化验项目管理',
      inside: true,
      login: true,
  ...
  //疫苗管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/VaccineManage.vue'], resolve),
    meta: {
      title: '疫苗管理',
      inside: true,
      login: true,
  ...
  //住院管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/Function/ClinicManage.vue'], resolve),
    meta: {
      title: '住院管理',
      inside: true,
      login: true,
  ...
  // 管理员管理
  {
    ...
    name: 'error',
    component: resolve => require(['@/views/setting/AdminSure.vue'], resolve),
    meta: {
      title: '管理员设置',
      inside: true,
      login: true,
    ...
    menu: for (let index = 0; index < user_aside_menu.length; index++) {
      for (let i = 0; i < user_aside_menu[index].menu_item.length; i++) {
        if (user_aside_menu[index].menu_item[i].path == to.path) {
          if (user_aside_menu[index].menu_item[i].vist) {
