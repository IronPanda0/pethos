  ...
  <div>
    ...
    <el-dropdown trigger="click" style="font-size:100%;float:right;margin-right:10px">
      ...
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item icon="el-icon-user" @click.native="to('/setting/user')">个人中心</el-dropdown-item>
        <el-dropdown-item icon="el-icon-key" @click.native="to('/setting/password')">修改密码</el-dropdown-item>
        <!--  -->
        <el-dropdown-item icon="el-icon-remove-outline" @click.native="to('/login')">退出</el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        user: {
          user_pet_name: "PetHospital-Admin",
