...
<script>
  ...
  export default {
    data() {
      return {
        login_title: "PetHospital-Admin",
        login_adress: "PetHospital-Admin登录模板，极简超强的vue框架",
        login_form: {
          user_name: "PetHospital-Admin",
          user_password: "12453",
        },
